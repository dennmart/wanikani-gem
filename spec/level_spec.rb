...
RSpec.describe Wanikani::Level do
  ...
  describe ".radicals" do
    context "levels parameter" do
      it "can accept an Integer as a single level" do
        stub_request(:get, "https://www.wanikani.com/api/v1.2/user/WANIKANI-API-KEY/radicals/1").
      ...
      it "converts an array of Integers to a comma-separated string of levels" do
        stub_request(:get, "https://www.wanikani.com/api/v1.2/user/WANIKANI-API-KEY/radicals/2,5,10,25").
           to_return(body: File.new("spec/fixtures/radicals.json"))
  ...
  describe ".kanji" do
    context "levels parameter" do
      it "can accept an Integer as a single level" do
        stub_request(:get, "https://www.wanikani.com/api/v1.2/user/WANIKANI-API-KEY/kanji/1").
      ...
      it "converts an array of Integers to a comma-separated string of levels" do
        stub_request(:get, "https://www.wanikani.com/api/v1.2/user/WANIKANI-API-KEY/kanji/2,5,10,25").
           to_return(body: File.new("spec/fixtures/kanji.json"))
  ...
  describe ".vocabulary" do
    context "levels parameter" do
      it "can accept an Integer as a single level" do
        stub_request(:get, "https://www.wanikani.com/api/v1.2/user/WANIKANI-API-KEY/vocabulary/1").
      ...
      it "converts an array of Integers to a comma-separated string of levels" do
        stub_request(:get, "https://www.wanikani.com/api/v1.2/user/WANIKANI-API-KEY/vocabulary/2,5,10,25").
           to_return(body: File.new("spec/fixtures/vocabulary.json"))
